...
def process(my_project, sc_tod):
    ...
    spec = json.load(open(pnr_spec_dir/'pnr_assignment_spec_egress.json'))
    ...
    h5file["Skims"].create_dataset('DRV_TRN_WLK_XWAIT__'+asim_tod, 
...
def all_transit_assignment(my_project, transit_spec_dir, class_name, matrix_list):
    ...
    for name in matrix_list:
        ...
        try:
            ...
            h5file["Skims"].create_dataset(name+'__'+asim_tod, data=matrix_value.astype('uint16'),compression='gzip')
        except:
            print(name)
